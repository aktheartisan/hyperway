        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{url('admin')}}" class="app-brand-link">
              ...
              <span class="demo menu-text fw-bolder ms-2" style="font-size: 1.75rem;">HyperWay</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{url('address')}}" class="menu-link">
                ...
                <div data-i18n="Tables">Address</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Development</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('add_home')}}" class="menu-link">
                    <div data-i18n="Account">Add</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{url('manage_home')}}"class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Resources</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('add_resource')}}" class="menu-link">
                    <div data-i18n="Account">Add</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{url('manage_resource')}}"class="menu-link">
                    <div data-i18n="Notifications">Manage</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Gallery Image</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('add_gallery')}}" class="menu-link">
                    <div data-i18n="Basic">Add</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{url('manage_gallery')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bxs-caret-right-circle"></i>
                <div data-i18n="Authentications">Gallery Video</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('add_gallery1')}}" class="menu-link">
                    <div data-i18n="Basic">Add</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{url('manage_gallery1')}}" class="menu-link">
                    <div data-i18n="Basic">Manage</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Obligations</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('add_obligations')}}" class="menu-link">
                    <div data-i18n="Error">Add</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{url('manage_obligations')}}" class="menu-link">
            ...
            <!-- Tables -->
            <li class="menu-item">
              <a href="{{url('manage_contact')}}" class="menu-link">
            ...
            <!-- <li class="menu-item">
              <a href="{{url('manage_about')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table"></i>
